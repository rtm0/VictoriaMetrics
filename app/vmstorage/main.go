...
func writeStorageMetrics(w io.Writer, strg *storage.Storage) {
	...
	metrics.WriteCounterUint64(w, `vm_rows_ignored_total{reason="stale_nan_value"}`, m.NaNValueRows)
	...
	metrics.WriteCounterUint64(w, `vm_rows_ignored_total{reason="unmarshallable_metric_name"}`, m.UnmarshallableMetricNames)
